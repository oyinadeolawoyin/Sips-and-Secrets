...
const profileFormController = require("../controller/profileFormController");
...
router.get("/", profileFormController.getProfileForm);
router.post("/", validateForm, profileFormController.createProfile);
